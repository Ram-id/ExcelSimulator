...
// -------------------------------------------------------------------------
// CASE 1: Turnamen "Ujian Sekolah" (ExcelArena.id / MEWC)
// -------------------------------------------------------------------------
...
cases.push({
  ...
  instructions: {
    ...
    helperTable: {
      ...
      rows: [
        ...
        ['Level 2', 'Desk=R1C1', '399', "=XLOOKUP(E9, 'Student Data'!J2:J78, 'Student Data'!H2:H78)"],
  ...
  sheets: [
    {
      ...
      rows: [
        ...
        { rowNumber: 8, values: { level: 'Level 2', game: 'Contoh2', row_param: 1, col_param: 1, desk_param: 'R1C1', answer: 399, points: 0, hint: 'Gita Firmansyah (84+62+83+70+100 = 399)' } },
        { rowNumber: 9, values: { level: 'Level 2', game: 'Game 16', row_param: 10, col_param: 5, desk_param: 'R10C5', answer: '?', points: 5, hint: 'Total skor siswa di R10C5' } },
        { rowNumber: 10, values: { level: 'Level 2', game: 'Game 17', row_param: 4, col_param: 5, desk_param: 'R4C5', answer: '?', points: 5, hint: 'Total skor siswa di R4C5' } },
        { rowNumber: 11, values: { level: 'Level 2', game: 'Game 18', row_param: 11, col_param: 2, desk_param: 'R11C2', answer: '?', points: 5, hint: 'Total skor siswa di R11C2' } },

        { rowNumber: 12, values: { level: 'Level 3', game: 'Contoh3', row_param: 2, col_param: 0, desk_param: 'R2', answer: 3, points: 0, hint: 'Di Baris 2: Intan, Ayu, Arif (Total 3)' } },
        { rowNumber: 13, values: { level: 'Level 3', game: 'Game 31', row_param: 11, col_param: 0, desk_param: 'R11', answer: '?', points: 8, hint: 'Jumlah nama huruf vokal di Baris 11' } },
        { rowNumber: 14, values: { level: 'Level 3', game: 'Game 32', row_param: 0, col_param: 4, desk_param: 'C4', answer: '?', points: 8, hint: 'Jumlah nama huruf vokal di Kolom 4' } },

        { rowNumber: 15, values: { level: 'Bonus', game: 'Bonus 1', row_param: 0, col_param: 0, desk_param: 'Semua', answer: '?', points: 50, hint: 'Siapa siswa dengan total nilai tertinggi (#1) di kelas?' } }
      ],
      targetColumns: [
        {
          key: 'answer',
          ...
          expectedRowAnswers: {
            3: deskLayoutMatrix[2][6], // Ivan Pratama
            4: deskLayoutMatrix[7][6], // Abdul Malik
            5: deskLayoutMatrix[3][1], // Rizki Maulana
            6: deskLayoutMatrix[4][5], // Roy Prasetyo
            7: deskLayoutMatrix[3][5], // Aulia Rahma
            9: studentScoreMap[deskLayoutMatrix[9][4]].total, // Tri Wahyuni
            10: studentScoreMap[deskLayoutMatrix[3][4]].total, // Galih Nugraha
            11: studentScoreMap[deskLayoutMatrix[10][1]].total, // Hanafi
            13: deskLayoutMatrix[10].filter(n => /^[AEIOU]/i.test(n)).length, // R11
            14: deskLayoutMatrix.map(r => r[3]).filter(n => /^[AEIOU]/i.test(n)).length, // C4
            15: Object.entries(studentScoreMap).sort((a, b) => b[1].total - a[1].total)[0][0]
          }
        }
      ]
    },
  ...
  passingScore: 70,
  solutionBlueprints: [
    { columnLabel: 'Level 1: Pencarian Nama', formula: "=INDEX('Desk Layout'!A1:G11, C3, D3)", explanation: 'Mengambil nama siswa dari koordinat Baris C dan Kolom D pada denah meja' },
    { columnLabel: 'Level 2: Total Skor Posisi', formula: "=XLOOKUP(E9, 'Student Data'!J2:J78, 'Student Data'!H2:H78)", explanation: 'Mencocokkan posisi meja R...C... dengan data nilai siswa' }
  ]
});

// -------------------------------------------------------------------------
// CASE 2: Estimasi Biaya Renovasi Rumah & Material (Aritmatika Nyata)
// -------------------------------------------------------------------------
cases.push({
  id: 'EX-002',
  number: 2,
  ...
  difficulty: 'PEMULA',
  difficultyStars: 1,
  tags: ['Konstruksi', 'Anggaran', 'Aritmatika'],
  instructions: {
    ...
    helperTable: {
      ...
      headers: ['Komponen', 'Rumus'],
      rows: [
        ['Biaya Material', '=Qty * Harga Satuan'],
        ['Ongkos Tukang', '=Biaya Material * 15%'],
        ['Total Biaya', '=Biaya Material + Ongkos Tukang']
      ]
    },
  ...
  sheets: [
    {
      ...
      columns: [
        { key: 'no', label: 'No', letter: 'A' },
        { key: 'material', label: 'Nama Material Bangunan', letter: 'B' },
        { key: 'qty', label: 'Kebutuhan Qty', letter: 'C' },
        { key: 'harga', label: 'Harga Satuan (Rp)', letter: 'D' },
        { key: 'biaya_mat', label: 'Biaya Material (Rp)', letter: 'E' },
        { key: 'jasa', label: 'Ongkos Tukang 15% (Rp)', letter: 'F' },
        { key: 'total', label: 'Total Estimasi (Rp)', letter: 'G' },
      ],
      rows: [
        { rowNumber: 2, values: { no: 1, material: 'Semen Gresik 50kg', qty: 40, harga: 68000, biaya_mat: '?', jasa: '?', total: '?' } },
        { rowNumber: 3, values: { no: 2, material: 'Pasir Cor (Truk 6m3)', qty: 3, harga: 1850000, biaya_mat: '?', jasa: '?', total: '?' } },
        { rowNumber: 4, values: { no: 3, material: 'Batu Bata Merah Oven', qty: 3000, harga: 900, biaya_mat: '?', jasa: '?', total: '?' } },
        { rowNumber: 5, values: { no: 4, material: 'Cat Tembok Dulux 20L', qty: 4, harga: 1450000, biaya_mat: '?', jasa: '?', total: '?' } },
        { rowNumber: 6, values: { no: 5, material: 'Keramik Granit 60x60 (Dus)', qty: 25, harga: 195000, biaya_mat: '?', jasa: '?', total: '?' } }
      ],
      targetColumns: [
        {
          key: 'biaya_mat',
          ...
          expectedRowAnswers: { 2: 2720000, 3: 5550000, 4: 2700000, 5: 5800000, 6: 4875000 }
        },
        {
          key: 'jasa',
          letter: 'F',
          ...
          expectedRowAnswers: { 2: 408000, 3: 832500, 4: 405000, 5: 870000, 6: 731250 }
        },
        {
          key: 'total',
          letter: 'G',
          ...
          expectedRowAnswers: { 2: 3128000, 3: 6382500, 4: 3105000, 5: 6670000, 6: 5606250 }
        }
      ]
    }
  ],
  passingScore: 70,
  solutionBlueprints: [
    { columnLabel: 'Biaya Material', formula: '=C2*D2', explanation: 'Mengalikan jumlah kebutuhan material dengan harga per satuan' },
    { columnLabel: 'Ongkos Tukang', formula: '=E2*0.15', explanation: 'Menghitung 15% dari subtotal biaya material' },
    { columnLabel: 'Total Estimasi', formula: '=E2+F2', explanation: 'Menjumlahkan total biaya material dengan biaya ongkos jasa' }
  ]
});

// -------------------------------------------------------------------------
// CASE 3: Pencatatan Stok Masuk & Keluar Gudang (Inventory)
// -------------------------------------------------------------------------
cases.push({
  id: 'EX-003',
  number: 3,
  ...
  difficulty: 'PEMULA',
  difficultyStars: 2,
  tags: ['Gudang', 'Inventaris', 'IF', 'Stok'],
  instructions: {
    ...
    helperTable: {
      ...
      rows: [
        ...
        ['Status Reorder', '=IF(Stok Akhir <= Minimum, "REORDER SEGERA", "STOK AMAN")']
      ]
    },
  ...
  sheets: [
    {
      ...
      columns: [
        { key: 'sku', label: 'Kode SKU', letter: 'A' },
        { key: 'nama', label: 'Nama Barang Elektronik', letter: 'B' },
        { key: 'awal', label: 'Stok Awal', letter: 'C' },
        { key: 'masuk', label: 'Barang Masuk', letter: 'D' },
        { key: 'keluar', label: 'Barang Keluar', letter: 'E' },
        { key: 'akhir', label: 'Stok Akhir', letter: 'F' },
        { key: 'min', label: 'Batas Minimum', letter: 'G' },
        { key: 'status', label: 'Status Pengadaan', letter: 'H' },
      ],
      rows: [
        { rowNumber: 2, values: { sku: 'ELK-TV50', nama: 'Smart TV 50 Inch 4K', awal: 25, masuk: 10, keluar: 22, akhir: '?', min: 15, status: '?' } },
        { rowNumber: 3, values: { sku: 'ELK-KLS2', nama: 'Kulkas 2 Pintu Inverter', awal: 18, masuk: 8, keluar: 6, akhir: '?', min: 10, status: '?' } },
        { rowNumber: 4, values: { sku: 'ELK-MC01', nama: 'Mesin Cuci Front Loading', awal: 12, masuk: 5, keluar: 14, akhir: '?', min: 8, status: '?' } },
        { rowNumber: 5, values: { sku: 'ELK-AC10', nama: 'AC Split 1 PK Dual Inverter', awal: 30, masuk: 15, keluar: 38, akhir: '?', min: 12, status: '?' } },
        { rowNumber: 6, values: { sku: 'ELK-MW20', nama: 'Microwave Grill 23L', awal: 40, masuk: 10, keluar: 15, akhir: '?', min: 20, status: '?' } }
      ],
      targetColumns: [
        {
          key: 'akhir',
          ...
          expectedRowAnswers: { 2: 13, 3: 20, 4: 3, 5: 7, 6: 35 }
        },
        {
          key: 'status',
          letter: 'H',
          ...
          expectedRowAnswers: { 2: 'REORDER SEGERA', 3: 'STOK AMAN', 4: 'REORDER SEGERA', 5: 'REORDER SEGERA', 6: 'STOK AMAN' }
        }
      ]
    }
  ],
  passingScore: 70,
  solutionBlueprints: [
    { columnLabel: 'Stok Akhir', formula: '=C2+D2-E2', explanation: 'Menghitung sisa stok fisik setelah mutasi masuk dan keluar' },
    { columnLabel: 'Status Pengadaan', formula: '=IF(F2<=G2, "REORDER SEGERA", "STOK AMAN")', explanation: 'Memeriksa apakah stok saat ini berada di bawah batas minimum pengadaan' }
  ]
});

// -------------------------------------------------------------------------
// CASE 4: Data Pegawai & Gaji (Payroll HRD)
// -------------------------------------------------------------------------
cases.push({
  id: 'EX-004',
  number: 4,
...
// -------------------------------------------------------------------------
// CASE 5: Klasemen Seri A Liga Italy (Sports & Standings)
// -------------------------------------------------------------------------
cases.push({
  id: 'EX-005',
  number: 5,
...
// -------------------------------------------------------------------------
// CASE 6: Packing Dus Pesanan Gudang E-Commerce
// -------------------------------------------------------------------------
cases.push({
  id: 'EX-006',
  number: 6,
...
// -------------------------------------------------------------------------
// CASE 7: Championship EVE Online (MEWC 2023)
// -------------------------------------------------------------------------
cases.push({
  id: 'EX-007',
  number: 7,
...
// -------------------------------------------------------------------------
// CASE 8: Tagihan Invoice & Kasir Retail Sembako
// -------------------------------------------------------------------------
cases.push({
  id: 'EX-008',
  number: 8,
  ...
  difficulty: 'MENENGAH',
  difficultyStars: 3,
  tags: ['Kasir', 'Retail', 'VLOOKUP', 'Invoice'],
  instructions: {
    ...
    helperTable: {
      ...
      headers: ['Barcode', 'Nama Produk', 'Harga'],
      rows: [
        ['BRC-01', 'Minyak Goreng Sania 2L', 'Rp 34.000'],
        ['BRC-02', 'Beras Ramos Super 5kg', 'Rp 74.000'],
        ['BRC-03', 'Gula Kristal Putih 1kg', 'Rp 17.500'],
        ['BRC-04', 'Susu Kental Manis Frisian', 'Rp 12.000'],
        ['BRC-05', 'Kopi Kapal Api Special 165g', 'Rp 15.000']
      ]
    },
  ...
  sheets: [
    {
      ...
      columns: [
        { key: 'no', label: 'No', letter: 'A' },
        { key: 'barcode', label: 'Barcode', letter: 'B' },
        { key: 'nama_barang', label: 'Nama Produk', letter: 'C' },
        { key: 'qty', label: 'Qty Beli', letter: 'D' },
        { key: 'harga', label: 'Harga Satuan (Rp)', letter: 'E' },
        { key: 'subtotal', label: 'Subtotal (Rp)', letter: 'F' },
        { key: 'diskon', label: 'Diskon Member (Rp)', letter: 'G' },
        { key: 'total', label: 'Total Bayar (Rp)', letter: 'H' },
      ],
      rows: [
        { rowNumber: 2, values: { no: 1, barcode: 'BRC-01', nama_barang: '?', qty: 3, harga: '?', subtotal: '?', diskon: 5000, total: '?' } },
        { rowNumber: 3, values: { no: 2, barcode: 'BRC-02', nama_barang: '?', qty: 2, harga: '?', subtotal: '?', diskon: 10000, total: '?' } },
        { rowNumber: 4, values: { no: 3, barcode: 'BRC-03', nama_barang: '?', qty: 4, harga: '?', subtotal: '?', diskon: 0, total: '?' } },
        { rowNumber: 5, values: { no: 4, barcode: 'BRC-05', nama_barang: '?', qty: 5, harga: '?', subtotal: '?', diskon: 3000, total: '?' } }
      ],
      targetColumns: [
        {
          key: 'nama_barang',
          ...
          expectedRowAnswers: { 2: 'Minyak Goreng Sania 2L', 3: 'Beras Ramos Super 5kg', 4: 'Gula Kristal Putih 1kg', 5: 'Kopi Kapal Api Special 165g' }
        },
        {
          key: 'harga',
          letter: 'E',
          ...
          expectedRowAnswers: { 2: 34000, 3: 74000, 4: 17500, 5: 15000 }
        },
        {
          key: 'subtotal',
          letter: 'F',
          label: 'Subtotal',
          description: 'Qty * Harga Satuan',
          expectedRowAnswers: { 2: 102000, 3: 148000, 4: 70000, 5: 75000 }
        },
        {
          key: 'total',
          letter: 'H',
          ...
          expectedRowAnswers: { 2: 97000, 3: 138000, 4: 70000, 5: 72000 }
        }
      ]
    },
    {
      ...
      name: 'Daftar Harga',
      columns: [
        { key: 'barcode', label: 'Kode Barcode', letter: 'A' },
        { key: 'nama', label: 'Nama Produk', letter: 'B' },
        { key: 'harga', label: 'Harga Satuan (Rp)', letter: 'C' },
      ],
      rows: [
        { rowNumber: 2, values: { barcode: 'BRC-01', nama: 'Minyak Goreng Sania 2L', harga: 34000 } },
        { rowNumber: 3, values: { barcode: 'BRC-02', nama: 'Beras Ramos Super 5kg', harga: 74000 } },
        { rowNumber: 4, values: { barcode: 'BRC-03', nama: 'Gula Kristal Putih 1kg', harga: 17500 } },
        { rowNumber: 5, values: { barcode: 'BRC-04', nama: 'Susu Kental Manis Frisian', harga: 12000 } },
        { rowNumber: 6, values: { barcode: 'BRC-05', nama: 'Kopi Kapal Api Special 165g', harga: 15000 } }
      ]
    }
  ],
  passingScore: 70,
  solutionBlueprints: [
    { columnLabel: 'Nama Produk', formula: "=VLOOKUP(B2, 'Daftar Harga'!A2:C6, 2, FALSE)", explanation: 'Mengambil nama produk dari sheet Daftar Harga' },
    { columnLabel: 'Harga Satuan', formula: "=VLOOKUP(B2, 'Daftar Harga'!A2:C6, 3, FALSE)", explanation: 'Mengambil harga satuan dari sheet Daftar Harga' },
    { columnLabel: 'Total Bayar', formula: '=F2-G2', explanation: 'Mengurangi subtotal dengan diskon member' }
  ]
});

// -------------------------------------------------------------------------
// CASE 9: Master DATEDIF Masa Kerja Pegawai (HRD)
// -------------------------------------------------------------------------
cases.push({
  id: 'EX-009',
  number: 9,
  ...
  instructions: {
    ...
    helperTable: {
      ...
      headers: ['Satuan', 'Kode Unit'],
      rows: [
        ['Jumlah Tahun Penuh', '"Y"'],
        ['Jumlah Sisa Bulan', '"YM"'],
        ['Jumlah Hari Penuh', '"D"']
      ]
    },
  ...
  sheets: [
    {
      ...
      columns: [
        { key: 'nik', label: 'NIK', letter: 'A' },
        { key: 'nama', label: 'Nama Karyawan', letter: 'B' },
        { key: 'join', label: 'Tanggal Masuk', letter: 'C' },
        { key: 'eval', label: 'Tanggal Evaluasi', letter: 'D' },
        { key: 'thn', label: 'Masa Kerja (Tahun)', letter: 'E' },
        { key: 'bln', label: 'Sisa Masa (Bulan)', letter: 'F' },
        { key: 'senioritas', label: 'Status Senioritas', letter: 'G' },
      ],
      rows: [
        { rowNumber: 2, values: { nik: 'KRY-01', nama: 'Bambang Wijaya', join: '2016-03-15', eval: '2026-08-01', thn: '?', bln: '?', senioritas: '?' } },
        { rowNumber: 3, values: { nik: 'KRY-02', nama: 'Lilis Suryani', join: '2023-01-10', eval: '2026-08-01', thn: '?', bln: '?', senioritas: '?' } },
        { rowNumber: 4, values: { nik: 'KRY-03', nama: 'Eko Purwanto', join: '2019-09-01', eval: '2026-08-01', thn: '?', bln: '?', senioritas: '?' } },
        { rowNumber: 5, values: { nik: 'KRY-04', nama: 'Ratna Sari', join: '2024-05-20', eval: '2026-08-01', thn: '?', bln: '?', senioritas: '?' } },
        { rowNumber: 6, values: { nik: 'KRY-05', nama: 'Tri Wahyuni', join: '2018-12-01', eval: '2026-08-01', thn: '?', bln: '?', senioritas: '?' } }
      ],
      targetColumns: [
        {
          key: 'thn',
          ...
          expectedRowAnswers: { 2: 10, 3: 3, 4: 6, 5: 2, 6: 7 }
        },
        {
          key: 'bln',
          letter: 'F',
          ...
          expectedRowAnswers: { 2: 4, 3: 6, 4: 11, 5: 2, 6: 8 }
        },
        {
          key: 'senioritas',
          letter: 'G',
          ...
          expectedRowAnswers: { 2: 'SENIOR', 3: 'JUNIOR', 4: 'SENIOR', 5: 'JUNIOR', 6: 'SENIOR' }
        }
      ]
    }
  ],
  passingScore: 70,
  solutionBlueprints: [
    { columnLabel: 'Masa Kerja (Tahun)', formula: '=DATEDIF(C2, D2, "Y")', explanation: 'Menghitung selisih tahun penuh antara dua tanggal' },
    { columnLabel: 'Status Senioritas', formula: '=IF(E2>=5, "SENIOR", "JUNIOR")', explanation: 'Menguji apakah masa kerja karyawan sudah mencapai minimal 5 tahun' }
  ]
});

// -------------------------------------------------------------------------
// CASE 10: Komisi Sales Otomotif Multi-Tier
// -------------------------------------------------------------------------
cases.push({
  id: 'EX-010',
  number: 10,
  ...
  difficulty: 'MENENGAH',
  difficultyStars: 3,
  tags: ['Sales', 'Komisi', 'IF Bertingkat'],
  instructions: {
    ...
    helperTable: {
      ...
      headers: ['Capaian Target', '% Komisi'],
      rows: [
        ['>= 100% Target', '5% dari Omset'],
        ['80% - 99% Target', '3% dari Omset'],
        ['< 80% Target', '1% dari Omset']
      ]
    },
  ...
  sheets: [
    {
      ...
      name: 'Komisi Sales',
      columns: [
        { key: 'id', label: 'ID Sales', letter: 'A' },
        { key: 'nama', label: 'Nama Sales Representative', letter: 'B' },
        { key: 'target', label: 'Target Omset (Rp)', letter: 'C' },
        { key: 'realisasi', label: 'Realisasi Omset (Rp)', letter: 'D' },
        { key: 'pct_capaian', label: '% Capaian', letter: 'E' },
        { key: 'rate', label: '% Rate Komisi', letter: 'F' },
        { key: 'komisi_rp', label: 'Nominal Komisi (Rp)', letter: 'G' },
      ],
      rows: [
        { rowNumber: 2, values: { id: 'SLS-01', nama: 'Gilang Ramadhan', target: 200000000, realisasi: 240000000, pct_capaian: '?', rate: '?', komisi_rp: '?' } },
        { rowNumber: 3, values: { id: 'SLS-02', nama: 'Siska Handayani', target: 200000000, realisasi: 180000000, pct_capaian: '?', rate: '?', komisi_rp: '?' } },
        { rowNumber: 4, values: { id: 'SLS-03', nama: 'Doni Setiawan', target: 150000000, realisasi: 105000000, pct_capaian: '?', rate: '?', komisi_rp: '?' } },
        { rowNumber: 5, values: { id: 'SLS-04', nama: 'Niken Larasati', target: 250000000, realisasi: 275000000, pct_capaian: '?', rate: '?', komisi_rp: '?' } }
      ],
      targetColumns: [
        {
          key: 'pct_capaian',
          ...
          expectedRowAnswers: { 2: 1.2, 3: 0.9, 4: 0.7, 5: 1.1 }
        },
        {
          key: 'rate',
          letter: 'F',
          ...
          expectedRowAnswers: { 2: 0.05, 3: 0.03, 4: 0.01, 5: 0.05 }
        },
        {
          key: 'komisi_rp',
          letter: 'G',
          ...
          expectedRowAnswers: { 2: 12000000, 3: 5400000, 4: 1050000, 5: 13750000 }
        }
      ]
    }
  ],
  passingScore: 70,
  solutionBlueprints: [
    { columnLabel: '% Capaian', formula: '=D2/C2', explanation: 'Membagi realisasi penjualan dengan target yang ditetapkan' },
    { columnLabel: '% Rate Komisi', formula: '=IF(E2>=1, 0.05, IF(E2>=0.8, 0.03, 0.01))', explanation: 'Menentukan persentase rate komisi berjenjang' }
  ]
});

// -------------------------------------------------------------------------
// CASE 11: Restoran F&B - HPP & Margin Profit
// -------------------------------------------------------------------------
cases.push({
  id: 'EX-011',
  number: 11,
  ...
  instructions: {
    ...
    helperTable: {
      ...
      headers: ['Indikator', 'Formula'],
      rows: [
        ['Laba Kotor', '=Harga Jual - Biaya Bahan HPP'],
        ['% Margin Laba', '=Laba Kotor / Harga Jual'],
  ...
  sheets: [
    {
      ...
      columns: [
        { key: 'kode', label: 'Kode Menu', letter: 'A' },
        { key: 'nama_menu', label: 'Nama Menu Makanan / Minuman', letter: 'B' },
        { key: 'hpp', label: 'Biaya Bahan HPP (Rp)', letter: 'C' },
        { key: 'jual', label: 'Harga Jual Menu (Rp)', letter: 'D' },
        { key: 'laba', label: 'Laba Kotor (Rp)', letter: 'E' },
        { key: 'margin', label: '% Margin Laba', letter: 'F' },
        { key: 'status_margin', label: 'Status Profitabilitas', letter: 'G' },
      ],
      rows: [
        { rowNumber: 2, values: { kode: 'MN-01', nama_menu: 'Espresso Single Origin 30ml', hpp: 4500, jual: 25000, laba: '?', margin: '?', status_margin: '?' } },
        { rowNumber: 3, values: { kode: 'MN-02', nama_menu: 'Iced Caramel Macchiato 16oz', hpp: 11000, jual: 38000, laba: '?', margin: '?', status_margin: '?' } },
        { rowNumber: 4, values: { kode: 'MN-03', nama_menu: 'Sirloin Steak Meltique 200g', hpp: 65000, jual: 115000, laba: '?', margin: '?', status_margin: '?' } },
        { rowNumber: 5, values: { kode: 'MN-04', nama_menu: 'Spaghetti Carbonara Creamy', hpp: 18000, jual: 42000, laba: '?', margin: '?', status_margin: '?' } }
      ],
      targetColumns: [
        {
          key: 'laba',
          ...
          expectedRowAnswers: { 2: 20500, 3: 27000, 4: 50000, 5: 24000 }
        },
        {
          key: 'margin',
          letter: 'F',
          ...
          expectedRowAnswers: { 2: 0.82, 3: 0.711, 4: 0.435, 5: 0.571 }
        },
        {
          key: 'status_margin',
          letter: 'G',
          ...
          expectedRowAnswers: { 2: 'HIGH MARGIN', 3: 'HIGH MARGIN', 4: 'STANDARD MARGIN', 5: 'STANDARD MARGIN' }
        }
      ]
    }
  ],
  passingScore: 70,
  solutionBlueprints: [
    { columnLabel: 'Laba Kotor', formula: '=D2-C2', explanation: 'Mengurangi harga jual dengan biaya pokok bahan baku' },
    { columnLabel: '% Margin Laba', formula: '=E2/D2', explanation: 'Menghitung persentase margin keuntungan dari harga jual' }
  ]
});

// -------------------------------------------------------------------------
// CASE 12: Pengolahan Nilai Rapor & Beasiswa Prestasi Siswa
// -------------------------------------------------------------------------
cases.push({
  id: 'EX-012',
  number: 12,
  ...
  difficulty: 'MENENGAH',
  difficultyStars: 3,
  tags: ['Sekolah', 'Guru', 'Nilai', 'AVERAGE', 'IF'],
  instructions: {
    ...
    helperTable: {
      ...
      headers: ['Rata-Rata Nilai', 'Status'],
      rows: [
        ['>= 75.0', 'LULUS'],
        ['< 75.0', 'REMIDI']
      ]
  ...
  sheets: [
    {
      ...
      columns: [
        ...
        { key: 'mat', label: 'Matematika', letter: 'C' },
        { key: 'ipa', label: 'IPA', letter: 'D' },
        { key: 'indo', label: 'B. Indonesia', letter: 'E' },
        { key: 'inggris', label: 'B. Inggris', letter: 'F' },
        { key: 'rata', label: 'Rata-Rata', letter: 'G' },
        { key: 'status', label: 'Status Kelulusan', letter: 'H' },
      ],
      rows: [
        { rowNumber: 2, values: { nis: '2026-01', nama: 'Ahmad Fauzi Rahman', mat: 88, ipa: 82, indo: 90, inggris: 84, rata: '?', status: '?' } },
        { rowNumber: 3, values: { nis: '2026-02', nama: 'Citra Dewi Anggraini', mat: 68, ipa: 72, indo: 74, inggris: 70, rata: '?', status: '?' } },
        { rowNumber: 4, values: { nis: '2026-03', nama: 'Dimas Bagas Pratama', mat: 92, ipa: 95, indo: 88, inggris: 91, rata: '?', status: '?' } },
        { rowNumber: 5, values: { nis: '2026-04', nama: 'Fitria Nur Hidayati', mat: 78, ipa: 80, indo: 85, inggris: 79, rata: '?', status: '?' } }
      ],
      targetColumns: [
        {
          key: 'rata',
          ...
          expectedRowAnswers: { 2: 86, 3: 71, 4: 91.5, 5: 80.5 }
        },
        {
          key: 'status',
          letter: 'H',
          ...
          expectedRowAnswers: { 2: 'LULUS', 3: 'REMIDI', 4: 'LULUS', 5: 'LULUS' }
        }
      ]
    }
  ],
  passingScore: 70,
  solutionBlueprints: [
    { columnLabel: 'Rata-Rata', formula: '=AVERAGE(C2:F2)', explanation: 'Menghitung nilai rata-rata dari 4 mata pelajaran' },
    { columnLabel: 'Status Kelulusan', formula: '=IF(G2>=75, "LULUS", "REMIDI")', explanation: 'Menguji apakah nilai rata-rata memenuhi KKM 75' }
  ]
});

// -------------------------------------------------------------------------
// CASE 13: Simulasi Angsuran Pinjaman KPR (Bank PMT)
// -------------------------------------------------------------------------
cases.push({
  id: 'EX-013',
  number: 13,
  ...
  difficulty: 'MAHIR',
  difficultyStars: 4,
  tags: ['Perbankan', 'KPR', 'PMT', 'Keuangan'],
  instructions: {
    ...
    helperTable: {
      ...
      headers: ['Argumen', 'Penjelasan'],
      rows: [
        ['Rate', 'Bunga Tahunan / 12 bulan (C2/12)'],
        ['Nper', 'Jumlah Total Bulan Tenor (D2*12)'],
        ['Pv', '-Plafon Pinjaman (-B2)']
      ]
    },
  ...
  sheets: [
    {
      ...
      columns: [
        ...
        { key: 'debitur', label: 'Nama Debitur', letter: 'E' },
        { key: 'angsuran', label: 'Angsuran / Bulan (Rp)', letter: 'F' },
        { key: 'total_bayar', label: 'Total Pembayaran (Rp)', letter: 'G' },
        { key: 'bunga_total', label: 'Total Bunga (Rp)', letter: 'H' },
      ],
      rows: [
        { rowNumber: 2, values: { no: 1, plafon: 500000000, bunga: 0.08, tenor: 15, debitur: 'Andi Pratama', angsuran: '?', total_bayar: '?', bunga_total: '?' } },
        { rowNumber: 3, values: { no: 2, plafon: 350000000, bunga: 0.075, tenor: 10, debitur: 'Citra Kirana', angsuran: '?', total_bayar: '?', bunga_total: '?' } },
        { rowNumber: 4, values: { no: 3, plafon: 800000000, bunga: 0.085, tenor: 20, debitur: 'Dimas Anggara', angsuran: '?', total_bayar: '?', bunga_total: '?' } },
        { rowNumber: 5, values: { no: 4, plafon: 250000000, bunga: 0.07, tenor: 5, debitur: 'Eka Saputra', angsuran: '?', total_bayar: '?', bunga_total: '?' } }
      ],
      targetColumns: [
        {
          key: 'angsuran',
          ...
          expectedRowAnswers: { 2: 4778260, 3: 4153835, 4: 6942621, 5: 4950371 }
        },
        {
          key: 'total_bayar',
          letter: 'G',
          ...
          expectedRowAnswers: { 2: 860086800, 3: 498460200, 4: 1666229040, 5: 297022260 }
        },
        {
          key: 'bunga_total',
          letter: 'H',
          ...
          expectedRowAnswers: { 2: 360086800, 3: 148460200, 4: 866229040, 5: 47022260 }
        }
      ]
    }
  ],
  passingScore: 70,
  solutionBlueprints: [
    { columnLabel: 'Angsuran / Bulan', formula: '=PMT(C2/12, D2*12, -B2)', explanation: 'Menghitung nilai angsuran anuitas bulanan tetap' },
    { columnLabel: 'Total Bunga', formula: '=G2-B2', explanation: 'Menghitung total porsi bunga yang dibayarkan selama masa tenor' }
  ]
});

// -------------------------------------------------------------------------
// CASE 14: Rekonsiliasi Mutasi Bank & Buku Kas Perusahaan
// -------------------------------------------------------------------------
cases.push({
  id: 'EX-014',
  number: 14,
  ...
  difficulty: 'EXTREME',
  difficultyStars: 5,
  tags: ['Akuntansi', 'Audit', 'Rekonsiliasi', 'Finance'],
  instructions: {
    ...
    helperTable: {
      ...
      headers: ['Kondisi Selisih', 'Status'],
      rows: [
        ['Selisih = 0', 'MATCH / SESUAI'],
        ['Selisih > 0', 'PERLU PENYESUAIAN']
      ]
    },
  ...
  sheets: [
    {
      ...
      rows: [
        { rowNumber: 2, values: { tgl: '01/08/2026', ket: 'Setoran Tunai Omset Kasir Toko', bank: 15000000, buku: 15000000, selisih: '?', status: '?' } },
        { rowNumber: 3, values: { tgl: '03/08/2026', ket: 'Pembayaran Kliring Cek Vendor', bank: 8500000, buku: 8500000, selisih: '?', status: '?' } },
        { rowNumber: 4, values: { tgl: '05/08/2026', ket: 'Biaya Administrasi Bank Bulanan', bank: 25000, buku: 0, selisih: '?', status: '?' } },
        { rowNumber: 5, values: { tgl: '07/08/2026', ket: 'Pendapatan Bunga Jasa Giro', bank: 180000, buku: 0, selisih: '?', status: '?' } },
        { rowNumber: 6, values: { tgl: '10/08/2026', ket: 'Transfer Pembayaran Klien PT Jaya', bank: 42000000, buku: 42000000, selisih: '?', status: '?' } }
      ],
      targetColumns: [
        {
          key: 'selisih',
          ...
          expectedRowAnswers: { 2: 0, 3: 0, 4: 25000, 5: 180000, 6: 0 }
        },
        {
          key: 'status',
          letter: 'F',
          ...
          expectedRowAnswers: { 2: 'MATCH / SESUAI', 3: 'MATCH / SESUAI', 4: 'PERLU PENYESUAIAN', 5: 'PERLU PENYESUAIAN', 6: 'MATCH / SESUAI' }
        }
      ]
    }
  ],
  passingScore: 70,
  solutionBlueprints: [
    { columnLabel: 'Selisih', formula: '=ABS(C2-D2)', explanation: 'Menghitung nilai mutlak selisih mutasi antara kedua rekening' },
    { columnLabel: 'Status Verifikasi', formula: '=IF(E2=0, "MATCH / SESUAI", "PERLU PENYESUAIAN")', explanation: 'Menguji apakah transaksi telah seimbang atau membutuhkan jurnal penyesuaian' }
  ]
});

// -------------------------------------------------------------------------
// CASE 15: Tarif Kamar Hotel & Lama Menginap (Perhotelan)
// -------------------------------------------------------------------------
cases.push({
  id: 'EX-015',
  number: 15,
  ...
  difficulty: 'MENENGAH',
  difficultyStars: 3,
  tags: ['Perhotelan', 'VLOOKUP', 'Tagihan'],
  instructions: {
    ...
    helperTable: {
      ...
      headers: ['Tipe Kamar', 'Tarif per Malam'],
      rows: [
        ['Standard Room', 'Rp 450.000'],
        ['Deluxe Room', 'Rp 750.000'],
        ['Executive Suite', 'Rp 1.250.000'],
        ['Presidential Suite', 'Rp 3.500.000']
      ]
    },
  ...
  sheets: [
    {
      ...
      name: 'Reservasi Tamu',
      columns: [
        { key: 'res_id', label: 'ID Booking', letter: 'A' },
        { key: 'tamu', label: 'Nama Tamu Hotel', letter: 'B' },
        { key: 'tipe', label: 'Tipe Kamar', letter: 'C' },
        { key: 'tarif', label: 'Tarif / Malam (Rp)', letter: 'D' },
        { key: 'malam', label: 'Lama (Malam)', letter: 'E' },
        { key: 'biaya_kamar', label: 'Biaya Kamar (Rp)', letter: 'F' },
        { key: 'extra', label: 'Extra Bed (Rp)', letter: 'G' },
        { key: 'total', label: 'Total Tagihan (Rp)', letter: 'H' },
      ],
      rows: [
        { rowNumber: 2, values: { res_id: 'BK-101', tamu: 'Ir. Soekarno Wibowo', tipe: 'Deluxe Room', tarif: '?', malam: 3, biaya_kamar: '?', extra: 200000, total: '?' } },
        { rowNumber: 3, values: { res_id: 'BK-102', tamu: 'Dra. Megawati Santoso', tipe: 'Executive Suite', tarif: '?', malam: 2, biaya_kamar: '?', extra: 0, total: '?' } },
        { rowNumber: 4, values: { res_id: 'BK-103', tamu: 'Dr. Habibie Rahman', tipe: 'Presidential Suite', tarif: '?', malam: 4, biaya_kamar: '?', extra: 500000, total: '?' } },
        { rowNumber: 5, values: { res_id: 'BK-104', tamu: 'Kusuma Wardani, S.E.', tipe: 'Standard Room', tarif: '?', malam: 1, biaya_kamar: '?', extra: 0, total: '?' } }
      ],
      targetColumns: [
        {
          key: 'tarif',
          ...
          expectedRowAnswers: { 2: 750000, 3: 1250000, 4: 3500000, 5: 450000 }
        },
        {
          key: 'biaya_kamar',
          letter: 'F',
          ...
          expectedRowAnswers: { 2: 2250000, 3: 2500000, 4: 14000000, 5: 450000 }
        },
        {
          key: 'total',
          letter: 'H',
          ...
          expectedRowAnswers: { 2: 2450000, 3: 2500000, 4: 14500000, 5: 450000 }
        }
      ]
    },
    {
      ...
      name: 'Master Tarif',
      columns: [
        { key: 'tipe', label: 'Tipe Kamar', letter: 'A' },
        { key: 'tarif', label: 'Tarif per Malam (Rp)', letter: 'B' },
      ],
      rows: [
        { rowNumber: 2, values: { tipe: 'Standard Room', tarif: 450000 } },
        { rowNumber: 3, values: { tipe: 'Deluxe Room', tarif: 750000 } },
        { rowNumber: 4, values: { tipe: 'Executive Suite', tarif: 1250000 } },
        { rowNumber: 5, values: { tipe: 'Presidential Suite', tarif: 3500000 } }
      ]
    }
  ],
  passingScore: 70,
  solutionBlueprints: [
    { columnLabel: 'Tarif / Malam', formula: "=VLOOKUP(C2, 'Master Tarif'!A2:B5, 2, FALSE)", explanation: 'Mengambil tarif harian dari tabel Master Tarif' },
    { columnLabel: 'Total Tagihan', formula: '=F2+G2', explanation: 'Menjumlahkan biaya sewa kamar dengan biaya fasilitas tambahan' }
  ]
});

// Write to src/lib/caseExamBank.ts
...
console.log(`Successfully generated ${cases.length} 100% authentic, hand-crafted case studies in src/lib/caseExamBank.ts`);
